...
export default function Filter({slides}:any){
    ...
    return(
        ...
        <div className="flex-1">
                <div className="w-[46vw] flex items-center">
                    <input type='search' placeholder="Search movies, series, novellas ..." className="outline-none 
                    text-bgPrimary hidden md:block placeholder-txtSecondary px-5 py-4 w-full bg-brTertiary rounded-full"/>
                    <i className="fa fa-search hidden md:block ml-[-30px] text-bgSecondary"/>
                </div>
